...
test_data_file = 'Fall 24 - Chatbot Auto Test Cases.csv'
openai_api_key = "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"  # Replace with your OpenAI API key
        ...
        if pdf_file.endswith(".pdf"):
            ...
            with pdfplumber.open(pdf_path) as pdf:
                for page in pdf.pages:
                    ...
                    if tables:
                        text += "\n\n" + "\n".join(
                            ["\t".join([str(cell) if cell is not None else '' for cell in row]) for row in tables if
                             row]
                        ) + "\n"
...
texts = [Document(page_content=chunk, metadata=doc.metadata) for doc in documents for chunk in
